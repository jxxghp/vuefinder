  ...
  <v-f-modal-layout>
    ...
    <template v-slot:buttons>
      <button :disabled="disableUploadButton" @click.prevent="handleUpload" type="button"
              ...
              class="mt-3 w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm">
        {{ t('Upload') }}
      </button>
